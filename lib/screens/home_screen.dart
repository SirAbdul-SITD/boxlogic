...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final tiers = [
      ('easy', 'Gentle', '~38 givens'),
      ('medium', 'Classic', '~30 givens'),
      ('hard', 'Sharp', '~25 givens'),
    ];
    return Scaffold(
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(color: Palette.jade, width: 2),
                      color: Palette.raised,
                    ),
                    child: const Icon(Icons.grid_on,
                        color: Palette.jade, size: 26),
                  ),
            ...
            Row(
              children: [
                Container(
                  ...
                  child: Icon(Icons.apps, color: accent, size: 24),
                ),
                const SizedBox(width: 14),
                Expanded(
                  child: Column(
